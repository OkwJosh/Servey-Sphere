"""
Django settings for surveysphere project.
...
SECRET_KEY = 'django-insecure-(r-vpko$55_^1#p+$ghg@r#oo2-738!5^$wicriy0zz+ega43c'
STATIC_URL = '/static/'
...
ROOT_URLCONF = 'surveysphere.urls'
...
WSGI_APPLICATION = 'surveysphere.wsgi.application'
